...
import CompleteChallengeContainer from
    './features/challenge/components/complete/CompleteChallengeContainer';
...
export default () => (
    <Route path="/" >
        ...
        <Route path="complete-challenge/:id" component={CompleteChallengeContainer} />
    </Route>
);
